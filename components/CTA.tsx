      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-[#1e293b]/50 backdrop-blur-xl border border-white/10 p-12 rounded-3xl shadow-2xl relative overflow-hidden">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-brand-dark px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.3)] transform hover:-translate-y-1"
          >
